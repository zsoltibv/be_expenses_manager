...
public class ExpenseController {
    ...
    public ResponseEntity<List<Expense>> getExpensesByUserId(@PathVariable Integer userId, @RequestParam(required = false) LocalDate startDate, @RequestParam(required = false) LocalDate endDate) {

        List<Expense> expenses = expenseService.getExpensesByUserId(userId, startDate, endDate);
